...
const ConsumerProfile = ({ navigation }: Props) => {
    ...
    return (
        <View style={[styles.container]}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('UpdateVehicle')}
                style={{
                    alignSelf: 'flex-end',
                    marginRight: 14,
                    marginTop: '8%'
            ...
            <View style={styles.innerView}>
                <ProfileText value={fullName} onChange={setFullName} placeholder='Enter name' />
                <ProfileText value={address} onChange={setAddress} placeholder='Addres' />
